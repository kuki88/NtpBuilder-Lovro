...
void __fastcall TformPosudbe::gridPosudbeCellClick(TColumn *Column)
{

	Kalendar2->MinDate = TPosudbe->FieldByName("datumPovratka")->AsDateTime;
}
//---------------------------------------------------------------------------

void __fastcall TformPosudbe::btnProduljiClick(TObject *Sender)
{
	TPosudbe->Edit();
	TPosudbe->FieldByName("datumPovratka")->AsDateTime = Kalendar2->Date;
	TPosudbe->Post();
}
//---------------------------------------------------------------------------
