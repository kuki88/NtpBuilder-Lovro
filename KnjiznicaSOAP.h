// ************************************************************************ //
// Invokable interface declaration header for KnjiznicaSOAP
// ************************************************************************ //
#ifndef   KnjiznicaSOAPH
#define   KnjiznicaSOAPH
...
// ************************************************************************ //
__interface INTERFACE_UUID("{3E9164C2-FF18-4101-BCF1-DD154BA07753}") IKnjiznicaSOAP : public IInvokable
{
public:
	...
	virtual int            generirajISBN(String devetBrojeva) = 0;
};
typedef DelphiInterface<IKnjiznicaSOAP> _di_IKnjiznicaSOAP;


#endif // KnjiznicaSOAPH
//---------------------------------------------------------------------------
